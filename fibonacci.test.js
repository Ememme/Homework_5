...
// Wg mnie nalezy przetestowac nastepujace przypadki:
// Poprawnosc działania funkcji, czyli takze wszystkie zdefiniowane warunki 'if' 
// Poprawnosc inputu (tylko liczby całkowite)
// Poprawnośc outputu (tablica)
...
test ('checks if input is an integer', ()=> {
    expect(fibo(-1)).toEqual('Please provide a valid argument. Fibonacci sequence is valid only for numbers >= 0');
})
